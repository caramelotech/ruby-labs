...
2. Faça commits atômicos com mensagens no padrão de Conventional Commits:
   ...
   ```
   feat: adicionar anotações sobre gems
...
4. Após aprovação, o merge será feito por um mantenedor. As notas são publicadas automaticamente no [site do Caramelo Labs](https://caramelotech.com.br/labs/ruby/) após o merge.
