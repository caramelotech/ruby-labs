...
Este é o repositório de **conteúdo** do Ruby Labs (Caramelo Tech):

- **Conteúdo:** 100% em `notes/`, Markdown puro em português brasileiro, sem frontmatter
- **Publicação:** o repositório hub [labs](https://github.com/caramelotech/labs) busca as notas daqui e publica em `https://caramelotech.com.br/labs/ruby/`
...
1. **Escolha o local:** a raiz de `notes/` (use o próximo prefixo numérico) ou uma nova subpasta de tema
...
Exemplo de nota nova (`notes/03-gems-essenciais.md`):
...
- Links para outras notas do site: caminho completo `/labs/ruby/<secao>/<nota>/`
